...
begin
  ...
  /*
   * Revision drafts must use publish_passage_bank_revision.
   */
  if v_draft.revision_of_passage_bank_id is not null
    ...
    raise exception
      using
        errcode = '22023',
        message =
          'Revision drafts must be published through the revision publication workflow.';
  end if;
  ...
  /*
   * ------------------------------------------------------------
   * 4. Validate saved draft containers
   * ------------------------------------------------------------
   */
  ...
  /*
   * ------------------------------------------------------------
   * 5. Build controlled publish payload
   * ------------------------------------------------------------
   */
  ...
  /*
   * ------------------------------------------------------------
   * 6. Publish passage and questions
   * ------------------------------------------------------------
   */
...
/*
 * Reassert privileges in the same migration.
 */
