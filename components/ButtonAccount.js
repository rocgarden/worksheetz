...
//app/components/ButtonAccount.js
"use client";
...
const ButtonAccount = ({ text = "Account" }) => {
  ...
  return (
    <Popover className="relative z-10 mx-10">
      {({ open }) => (
        <>
          <PopoverButton className="btn font-medium rounded-full  border-purple-700  p-2 hover:bg-purple-700 hover:text-white text-purple-700 text-md">
            {user?.user_metadata?.avatar_url ? (
              ...
              <span className="w-8 h-8 bg-base-100 flex justify-center items-center rounded-full border  p-2 hover:bg-purple-700 hover:text-white shrink-0 capitalize">
                {user?.email?.charAt(0)}
              </span>
            )}
