...
// const Hero = ({ isAuthenticated = false }) => {
//   return (
...
//           Create practice quizzes in minutes—not days{" "}
//         </h1>
//         <p className="text-lg opacity-80 leading-relaxed">
//           An AI-powered tool that helps educators instantly generate customized
//           worksheets by subject, grade level, and topic.{" "}
//         </p>
//         {/* <ButtonSignin
...
const Hero = ({ isAuthenticated = false }) => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-14 lg:gap-20 px-8 pt-14 pb-20 lg:pt-20 lg:pb-24">
      <div className="flex flex-col gap-7 items-center justify-center text-center lg:text-left lg:items-start">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-2">
          {!isAuthenticated ? (
            <>
              ...
              <ButtonSignin
                redirectTo="/dashboard"
                extraStyle="btn-secondary rounded-full btn-wide"
                text="View Teacher Dashboard"
              />
            </>
          ) : (
            <>
              ...
              <Link
                href="/dashboard"
                className="btn btn-secondary rounded-full btn-wide"
              >
                Open Dashboard
              </Link>
            </>
